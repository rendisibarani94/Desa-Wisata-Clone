        ...
        <div class="col-md-8">
            <div class="card">
                <div class="d-flex justify-content-center">
                    <img src="{{ asset('images/logo/logo.png') }}" class="card-header" width="100px" height="75px">
                  </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Periksa Kembali Email dan Password Anda</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end font-bold">Password</label>
