...
@section('Judul_Halaman','Fasilitas Rumah Makan')
@section('Konten')
<div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16 mt-4">
    <h1 class="text-4xl font-bold text-sky-950">Fasilitas Rumah Makan</h1>
    <h6 class="muy-2 mx-2 text-left font-semibold text-gray-800">Fasilitas Rumah Makan yang dapat ditemukan di Desa Wisata</h6>
        ...
        <div class="max-w-screen-lg mx-auto my-4">
            <div class="flex gap-3 p-5 bg-white shadow-xl shadow-slate-300 rounded-xl overflow-hidden items-center justify-start transition-transform hover:scale-105">
                ...
                <div class="relative w-48 h-48 flex-shrink-0">
                    <img src="{{ asset('images/fasilitas/rumah-makan/'.$item->gambar) }}" class="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50 rounded-lg" loading="lazy">
                </div>

                <div class="flex flex-col">
                    <p class="text-xl font-bold mb-5">{{ $item->namaRumahMakan }}</p>
                    ...
                    <div class="text-normal">
                        ...
                        <a href="{{ route('user.fasilitas.rumah-makan.detail', $item->id) }}" class="inline-flex items-center font-bold hover:text-blue-700">
                            Selengkapnya
