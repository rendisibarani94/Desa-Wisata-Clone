...
<div class="max-w-screen-lg mx-auto p-5 sm:p-10 md:p-16">
    <div class=" rounded overflow-hidden flex flex-col mx-auto">
        <p class="text-xl sm:text-4xl font-semibold inline-block mb-2 text-center">{{ $data->namaRumahIbadah }}</p>

        <div class="relative">
            <img src="{{ asset('images/fasilitas/rumah-ibadah/'.$data->gambar) }}" class="w-full">
            <br>
            ...
            <div class="bg-white shadow-lg p-5 rounded-lg mt-5">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-gray-800 mr-3">
                        <i class="fas fa-clock"></i> {{ $data->jadwalIbadah }}
                    </div>
                </div>
            </div>
