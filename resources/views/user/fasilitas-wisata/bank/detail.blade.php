...
@section('Judul_Halaman','Detail Bank')
@section('Konten')
<div class="max-w-screen-lg mx-auto p-5 sm:p-10 md:p-16">
    <div class=" rounded overflow-hidden flex flex-col mx-auto">
        <p class="text-xl sm:text-4xl font-semibold inline-block mb-2 text-center">{{ $data->namaBank }}</p>

        <div class="relative">
            <img src="{{ asset('images/fasilitas/bank/'.$data->gambar) }}" class="w-full">
            <br>
