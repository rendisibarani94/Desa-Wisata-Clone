...
@section('Judul_Halaman', 'Objek Wisata Kreatif')
@section('Konten')
<div class="mx-16 my-4">
    <p class="text-4xl font-bold text-indigo-950 font-roboto text-center mb-6">Objek Wisata Kreatif</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-6">
            ...
            <div class="max-w-sm bg-white rounded-lg shadow-xl shadow-slate-400 transition-transform hover:scale-105">
                ...
                <div class="p-5">
                    ...
                    <p class="mb-3 font-normal text-black dark:text-black-400">{!! Str::limitParagraph($item->deskripsi, 150, '...') !!}</p>
                    <br>
