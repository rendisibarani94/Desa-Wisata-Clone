...
<div class="flex justify-between mx-3">
    <h2 class="text-4xl mt-2 mx-2 font-roboto font-bold">Penginapan</h2>
    <a href="{{ route('admin.penginapan.store') }}" class="btn bg-gradient-success ml-auto mr-4 font-semibold mt-2">Tambah Data</a>
</div>
<br><br>
    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <div class="flex items-center">
                <input type="text" id="table_search" name="table_search" class="form-control form-control-sm w-64 mr-2" placeholder="Cari Penginapan...">
        ...
        <table class="table table-hover text-nowrap">
            ...
            <tbody id="table_body">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.penginapan.edit', $item->id) }}" class="btn btn-warning text-white font-semibold">Ubah</a>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = `/admin/penginapan/${itemId}`;
                        form.submit();
                    }
                })
            });
