...
@section('Judul_Tab', 'Edit Penginapan')
@section('Konten')
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form action="{{ route('admin.penginapan.update', $data->id) }}" method="POST" enctype="multipart/form-data" id="penginapanFormEdit">
        @csrf
        @method('PUT')
        <div class="card-body">
            {{-- Nama Penginapan --}}
            <div class="form-group">
                ...
                <input type="text" name="namaPenginapan" value="{{ $data->namaPenginapan }}" class="form-control" id="namaPenginapan" placeholder="Masukkan Nama Penginapan" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="harga" value="{{ $data->harga }}" class="form-control" id="harga" placeholder="Masukkan Harga Penginapan" autocomplete="off" min="0">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="lokasi" id="lokasi" rows="4" placeholder="Masukkan Deskripsi Tentang Penginapan">{{ $data->lokasi }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="deskripsi" id="deskripsi" rows="4" placeholder="Masukkan Deskripsi Tentang Penginapan">{{ $data->deskripsi }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="kontak" value="{{ $data->kontak }}" class="form-control" id="kontak" placeholder="Masukkan Kontak Penginapan" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="wifi" value="{{ $data->wifi }}" class="form-control" id="wifi" placeholder="Masukkan Status Wifi Penginapan" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="toilet" value="{{ $data->toilet }}" class="form-control" id="toilet" placeholder="Masukkan Status Toilet Penginapan" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ac" value="{{ $data->ac }}" class="form-control" id="ac" placeholder="Masukkan Status AC Penginapan" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="breakfast" value="{{ $data->breakfast }}" class="form-control" id="breakfast" placeholder="Masukkan Status Breakfast Penginapan" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="contactPerson" value="{{ $data->contactPerson }}" class="form-control" id="contactPerson" placeholder="Masukkan Status Contact Person Penginapan" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="cleaningService" value="{{ $data->cleaningService }}" class="form-control" id="cleaningService" placeholder="Masukkan Status Cleaning Service Penginapan" autocomplete="off">
            </div>
            ...
            @for($i = 1; $i <= 5; $i++) <div class="form-group">
                ...
                <img src="{{ asset('images/fasilitas/penginapan/'. $data->{'gambar'.$i} ) }}" id='img-upload{{ $i }}' style="width: 400px;" class="mx-auto">
        </div>
        @endfor
...
<script>
    $(document).ready(function() {
        ...
        $('#penginapanFormEdit').on('submit', function(event) {
        ...
        $('#penginapanFormEdit').on('submit', function(event) {
            ...
            if (lokasi === '') {
                ...
                // Scroll to the top of the form group containing the editor
                $('#namaPenginapan').focus();
