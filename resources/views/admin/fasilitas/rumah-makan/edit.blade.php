...
@section('Judul_Tab', 'Edit Rumah Makan')
@section('Konten')
...
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="rumahMakanFormEdit" action="{{ route('admin.rumahMakan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            {{-- Nama Rumah Makan --}}
            ...
            <div id="namaRumahMakan-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="namaRumahMakan" value="{{ $data->namaRumahMakan }}" class="form-control" id="namaRumahMakan" placeholder="Masukkan Nama Rumah Makan" autocomplete="off">
            </div>
            ...
            <div id="lokasi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="lokasi" value="{{ $data->lokasi }}" class="form-control" id="lokasi" placeholder="Masukkan Lokasi Rumah Makan" autocomplete="off">
            </div>
            ...
            <div id="deskripsi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <textarea class="deskripsi w-full" name="deskripsi" id="deskripsi" rows="4" placeholder="Masukkan Deskripsi Tentang Rumah Makan">{{ $data->deskripsi }}</textarea>
            </div>
            ...
            <div id="waktuOperasi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="waktuOperasi" value="{{ $data->waktuOperasi }}" class="form-control" id="waktuOperasi" placeholder="Masukkan Jadwal Beroprasi Rumah Makan" autocomplete="off">
            </div>
            ...
            <div id="jamBuka-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="time" name="jamBuka" value="{{ $data->jamBuka }}" class="form-control" id="jamBuka" placeholder="Waktu Buka Rumah Makan" autocomplete="off">
            </div>
            ...
            <div id="jamTutup-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="time" name="jamTutup" value="{{ $data->jamTutup }}" class="form-control" id="jamTutup" placeholder="Waktu Tutup Rumah Makan" autocomplete="off">
            </div>
            ...
            <img src="{{ asset('images/fasilitas/rumah-makan/'. $data->gambar) }}" id='img-upload' style="width: 400px;" class="mx-auto">
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Form Validation
            $('#rumahMakanFormEdit').on('submit', function(event) {
