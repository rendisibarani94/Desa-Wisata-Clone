...
@section('Judul_Tab', 'Edit Fasilitas Kesehatan')
@section('Konten')
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="editFasilitasKesehatanForm" action="{{ route('fasilitas-kesehatan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            ...
            <div id="namaFasilitasKesehatan-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="namaFasilitasKesehatan" value="{{ $data->namaFasilitasKesehatan }}" class="form-control" id="namaFasilitasKesehatan" placeholder="Masukkan Nama Fasilitas Kesehatan" autocomplete="off">
            </div>
            <div id="namaFasilitasKesehatan-error" style="color: red; display: none;">Maksimal Input Nama Fasilitas Adalah 255 Karakter!</div>
            ...
            <div id="lokasi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="lokasi" value="{{ $data->lokasi }}" class="form-control" id="lokasi" placeholder="Masukkan Lokasi Fasilitas Kesehatan" autocomplete="off">
            </div>
            ...
            <div id="deskripsi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <textarea class="deskripsi w-full" name="deskripsi" id="deskripsi" rows="4" placeholder="Masukkan Deskripsi Tentang Fasilitas Kesehatan">{{ $data->deskripsi }}</textarea>
            </div>
            ...
            <div id="waktuOperasi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="waktuOperasi" value="{{ $data->waktuOperasi }}" class="form-control" id="waktuOperasi" placeholder="Masukkan Jadwal Operasi Fasilitas Kesehatan" autocomplete="off">
            </div>
            ...
            <div id="jamBuka-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="time" name="jamBuka" value="{{ $data->jamBuka }}" class="form-control" id="jamBuka" placeholder="Waktu Buka Fasilitas" autocomplete="off">
            </div>
            ...
            <div id="jamTutup-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="time" name="jamTutup" value="{{ $data->jamTutup }}" class="form-control" id="jamTutup" placeholder="Waktu Tutup Fasilitas" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <img src="{{ asset('images/fasilitas/fasilitas-kesehatan/'. $data->gambar) }}" id='img-upload' style="width: 400px;" class="mx-auto">
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editFasilitasKesehatanForm').on('submit', function(event) {
