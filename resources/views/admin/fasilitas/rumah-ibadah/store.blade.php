...
@section('Judul_Tab', 'Tambah Rumah Ibadah')
@section('Konten')
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="rumahIbadahFormStore" action="{{ route('admin.rumahIbadah.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            {{-- Nama Rumah Ibadah --}}
            ...
            <div id="namaRumahIbadah-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="namaRumahIbadah" class="form-control" id="namaRumahIbadah" placeholder="Masukkan Nama Rumah Ibadah" autocomplete="off">
            </div>
            ...
            <div id="lokasi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="lokasi" class="form-control" id="lokasi" placeholder="Masukkan Lokasi Rumah Ibadah" autocomplete="off">
            </div>
            ...
            <div id="deskripsi-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <textarea class="deskripsi w-full" name="deskripsi" id="deskripsi" rows="4" placeholder="Masukkan Deskripsi Tentang Rumah Ibadah"></textarea>
            </div>
            ...
            <div id="jadwalIbadah-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <textarea class="summernote w-full" name="jadwalIbadah" id="jadwalIbadah" rows="4"></textarea>
            </div>
            ...
            <div class="form-group">
                <div class="flex">
                    <label>Gambar Rumah Ibadah</label>
...
<script>
    $(document).ready(function() {
        ...
        // Form Validation
        $('#rumahIbadahFormStore').on('submit', function(event) {
