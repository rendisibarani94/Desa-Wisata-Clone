...
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="umkmFormSouvenirStore" action="{{ route('admin.umkm.sovenir.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="custom-select rounded-0" name="id_kategori_umkm" id="exampleSelectRounded0">
                    <option value="1">Produk Makanan</option>
                    <option value="2" selected>Produk Sovenir</option>
            ...
            <div id="harga-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="number" name="harga" value="{{$data->harga }}" class="form-control" id="harga" placeholder="Masukkan Harga Produk " autocomplete="off" min="0">
            </div>
            ...
            <div class="card-footer flex justify-between">
                <a href="{{ route('admin.umkm.sovenir.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">Kembali</a>
                <button type="submit" class="bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-2 px-4 rounded ml-auto">Ubah
                    Data</button>
            </div>
        </div>
    </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Form Validation
            $('#umkmFormSouvenirStore').on('submit', function(event) {
