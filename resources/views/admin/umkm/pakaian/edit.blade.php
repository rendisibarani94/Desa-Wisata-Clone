...
@section('Judul_Tab', 'Edit Data Produk UMKM')
@section('Konten')
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="umkmFormPakaianEdit" action="{{ route('admin.umkm.pakaian.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="custom-select rounded-0" name="id_kategori_umkm" id="exampleSelectRounded0">
                    <option value="1" {{ $data->id_kategori_umkm == 1 ? 'selected' : '' }}>Produk Makanan</option>
                    <option value="2" {{ $data->id_kategori_umkm == 2 ? 'selected' : '' }}>Produk Sovenir</option>
                    <option value="3" {{ $data->id_kategori_umkm == 3 ? 'selected' : '' }}>Produk Pakaian</option>
                </select>
            </div>
            ...
            <div id="namaProduk-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="namaProduk" value="{{ $data->namaProduk }}" class="form-control" id="namaProduk" placeholder="Masukkan Nama Produk " autocomplete="off">
            </div>
            ...
            <div id="harga-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="number" name="harga" class="form-control" id="harga" value="{{ $data->harga }}" placeholder="Masukkan Harga Produk" autocomplete="off" min="0">
                <small id="hargaError" class="form-text text-danger" style="display: none;">Harga Tidak Boleh Minus</small>
            </div>
            ...
            <div id="namaQuantity-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="namaQuantity" value="{{ $data->namaQuantity }}" class="form-control" id="namaQuantity" placeholder="Masukkan Nama Kuantitas Produk " autocomplete="off">
            </div>
            ...
            <div id="namaKontak-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="namaKontak" value="{{ $data->namaKontak }}" class="form-control" id="namaKontak" placeholder="Masukkan Nama Pemilik Produk UMKM " autocomplete="off">
            </div>
            ...
            <div id="kontak-empty-error" class="font-semibold text-red-500 ml-2" style="display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="number" name="kontak" value="{{ $data->kontak }}" class="form-control" id="kontak" placeholder="Masukkan Kontak Pemilik Produk UMKM" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <img src="{{ asset('images/produk-umkm/'. $data->gambar) }}" id='img-upload' style="width: 400px;" class="mx-auto">
            </div>

            {{-- Button Submit --}}
            <div class="card-footer flex justify-between">
                <a href="{{ route('admin.umkm.pakaian.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">Kembali</a>
                <button type="submit" class="bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-2 px-4 rounded ml-auto">Ubah Data</button>
            </div>
        </div>
    </form>
    <!-- /.card-body -->
...
<script>
    $(document).ready(function() {
        ...
        // Form Validation
        $('#umkmFormPakaianEdit').on('submit', function(event) {
