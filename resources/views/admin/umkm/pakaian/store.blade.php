...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="umkmFormPakaianEdit" action="{{ route('admin.umkm.pakaian.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="custom-select rounded-0" name="id_kategori_umkm" id="exampleSelectRounded0">
                    ...
                    <option value="3" selected>Produk Pakaian</option>
                </select>
            </div>
