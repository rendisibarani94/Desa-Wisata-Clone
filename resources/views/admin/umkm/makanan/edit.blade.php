...
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="umkmFormMakananEdit" action="{{ route('admin.umkm.makanan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Form Validation
            $('#umkmFormMakananEdit').on('submit', function(event) {
