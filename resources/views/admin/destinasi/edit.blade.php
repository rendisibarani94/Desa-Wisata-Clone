...
@section('Judul_Tab', 'Edit Destinasi')
@section('Konten')
...
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="editDestinasiForm" action="{{ route('destinasi.update', $destinasi->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="custom-select rounded-0" name="idKategoriWisata" id="exampleSelectRounded0">
                    <option value="1" {{ $destinasi->idKategoriWisata == 1 ? 'selected' : '' }}>Wisata Alam</option>
                    <option value="2" {{ $destinasi->idKategoriWisata == 2 ? 'selected' : '' }}>Wisata Budaya</option>
                    <option value="3" {{ $destinasi->idKategoriWisata == 3 ? 'selected' : '' }}>Wisata Kreatif</option>
                </select>
            </div>
            ...
            <div id="namaObjekWisata-empty-error" class="font-semibold ml-2 text-red-500" style=" display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="namaObjekWisata" value="{{ $destinasi->namaObjekWisata }}" class="form-control" id="namaObjekWisata" placeholder="Masukkan Nama Destinasi" autocomplete="off">
            </div>
            ...
            <div id="lokasi-empty-error" class="font-semibold ml-2 text-red-500" style=" display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="text" name="lokasi" value="{{ $destinasi->lokasi }}" class="form-control" id="lokasi" placeholder="Masukkan Alamat" autocomplete="off">
            </div>
            ...
            <div id="jamBuka-empty-error" class="font-semibold ml-2 text-red-500" style=" display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="time" name="jamBuka" value="{{ $destinasi->jamBuka }}" class="form-control" id="jamBuka" placeholder="Waktu Buka Destinasi" autocomplete="off">
            </div>
            ...
            <div id="jamTutup-empty-error" class="font-semibold ml-2 text-red-500" style=" display: none;">*Bidang ini harus diisi!</div>
                ...
                <input type="time" name="jamTutup" value="{{ $destinasi->jamTutup }}" class="form-control" id="jamTutup" placeholder="Waktu Tutup Destinasi" autocomplete="off">
            </div>
            ...
            <div class="input-group">
                <input type="text" name="waktuOperasi" value="{{ $destinasi->waktuOperasi }}" id="waktuOperasi" class="form-control" autocomplete="off">
            </div>
            ...
            <div id="kontak-empty-error" class="font-semibold ml-2 text-red-500" style=" display: none;">*Bidang ini harus diisi!</div>
            ...
            <div class="input-group">
                ...
                <input type="number" value="{{ $destinasi->kontak }}" name="kontak" id="kontakDestinasi" class="form-control">
            </div>
            ...
            <div id="deskripsiDestinasi-empty-error" class="font-semibold ml-2 text-red-500" style=" display: none;">*Bidang ini harus diisi!</div>
                ...
                <textarea class="summernote deskripsiDestinasi w-full" name="deskripsi" id="deskripsiDestinasi" rows="4" placeholder="Masukkan Deskripsi Menarik Tentang Destinasi Wisata">
                {{ $destinasi->deskripsi }}
                </textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <img src="{{ asset('images/objek-wisata/'. $destinasi->gambar) }}" id='img-upload' style="width: 400px;" class="mx-auto">
            </div>
        ...
        $(document).ready(function() {
            ...
            $('#lokasi').on('input', function() {
                ...
                if (lokasiInput.val().length > 255) {
                    lokasiInput.val(lokasiInput.val().substring(0, 255)); // Truncate the input to 255 Karakters
                    lokasiError.show();
                } else {
                    lokasiError.hide();
                }
            ...
            $('#namaObjekWisata').on('input', function() {
                ...
                if (namaObjekWisataInput.val().length > 255) {
                    namaObjekWisataInput.val(namaObjekWisataInput.val().substring(0, 255)); // Truncate the input to 255 Karakters
            ...
            $('#waktuOperasi').on('input', function() {
                ...
                if (waktuOperasiInput.val().length > 255) {
                    waktuOperasiInput.val(waktuOperasiInput.val().substring(0, 255)); // Truncate the input to 255 Karakters
            ...
            // Form Validation
            $('#editDestinasiForm').on('submit', function(event) {
