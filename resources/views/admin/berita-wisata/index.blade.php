...
@section('Judul_Tab', 'Berita Wisata')
@section('Konten')
...
<div class="flex justify-between mx-3">
    <h2 class="text-4xl mt-2 mx-2 font-roboto font-bold">Berita Wisata</h2>
    <a href="{{ route('berita-wisata.store') }}" class="btn bg-gradient-success ml-auto mr-4 font-semibold mt-2">Tambah Data</a>

</div>
<br><br>
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Data Berita Wisata</h3>
        ...
        <table class="table table-hover text-nowrap">
            ...
            <tbody id="table_body">
                ...
                <tr>
                    ...
                    <td>{{ Str::limitParagraph(strip_tags($item->judulBerita), 50) }}</td>

                    <td>{{ $item->penulis }}</td>
                    <td>{{ $item->tanggalBerita }}</td>
                    <td>
                        <a href="{{ route('berita-wisata.edit', $item->id) }}" class="btn btn-warning text-white font-semibold">Ubah</a>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = `/admin/berita-wisata/${itemId}`;
                        form.submit();
                    }
                });
            });
