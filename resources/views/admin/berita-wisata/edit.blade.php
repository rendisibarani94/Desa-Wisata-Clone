...
@section('Judul_Tab', 'Edit Berita Wisata')
@section('Konten')
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="editBeritaWisataForm" action="{{ route('berita-wisata.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            {{-- {{ Auth::user()->id }} --}}
            ...
            <div class="form-group">
                ...
                <input type="text" name="judulBerita" value="{{ $data->judulBerita }}" class="form-control" id="judulBerita" placeholder="Masukkan Nama Destinasi" autocomplete="off">
            </div>
            <div id="judulBerita-error" style="color: red; display: none;">Maksimal Input Judul Berita Adalah 255 Karakter!</div>
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggalBerita" value="{{ $data->tanggalBerita }}" class="form-control" id="tanggalBerita" placeholder="Masukkan Alamat" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="deskripsiBeritaWisata w-full" name="deskripsi" id="deskripsiBeritaWisata" rows="4" placeholder="Masukkan Deskripsi Menarik Tentang Berita Wisata">{{ $data->deskripsi }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="isiBerita" id="isiBerita" rows="4">{{ $data->isiBerita }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <img src="{{ asset('images/berita-wisata/'. $data->gambar) }}" id='img-upload' style="width: 400px;" class="mx-auto">
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Form Validation
            $('#editBeritaWisataForm').on('submit', function(event) {
            ...
            // Karakter length restriction for Judul Berita
            $('#judulBerita').on('input', function() {
                ...
                if (judulBeritaInput.val().length > 255) {
                    judulBeritaInput.val(judulBeritaInput.val().substring(0, 255)); //Truncate the input to 255 Karakter
        ...
        //     const judulBeritaInput = document.getElementById('judulBerita');
        //     const judulBeritaDiv = document.getElementById('judulBerita-error');

        //     //lokasi
        //     judulBeritaInput.addEventListener('input', function() {
        //         if (judulBeritaInput.value.length > 255) {
        //             judulBeritaDiv.style.display = 'block';
        //             judulBeritaInput.value = judulBeritaInput.value.substring(0, 255); // Prevent further input
        //         } else {
        //             judulBeritaDiv.style.display = 'none';
        //         }
        //     });
        // });
