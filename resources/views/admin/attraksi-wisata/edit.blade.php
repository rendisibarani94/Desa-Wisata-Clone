...
@section('Judul_Tab', 'Ubah Atraksi Wisata')
@section('Konten')
...
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="editAtraksiWisataForm" action="{{ route('atraksi-wisata.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            {{-- Nama Atraksi --}}
            <div class="form-group">
                ...
                <input type="text" name="namaAtraksi" value="{{ $data->namaAtraksi }}" class="form-control" id="namaAtraksi" placeholder="Masukkan Nama Atraksi " autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="deskripsiSingkat w-full" name="deskripsiSingkat" id="deskripsiSingkat" rows="4" placeholder="Masukkan Deskripsi Menarik Tentang Atraksi Wisata">{{ $data->deskripsiSingkat }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="tarif" value="{{ $data->tarif }}" class="form-control" id="tarif" placeholder="Masukkan Tarif Atraksi" autocomplete="off" min="0">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="lokasi" class="form-control" value="{{ $data->lokasi }}" id="lokasi" placeholder="Masukkan Lokasi Atraksi" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="isiAtraksi" id="isiAtraksi" rows="4">{{ $data->isiAtraksi }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <img src="{{ asset('images/atraksi-wisata/'. $data->gambar) }}" id='img-upload' style="width: 400px;" class="mx-auto">
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editAtraksiWisataForm').on('submit', function(event) {
