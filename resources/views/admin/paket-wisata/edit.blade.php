...
@section('Judul_Tab', 'Ubah Paket Wisata')
@section('Konten')
<div class="card card-warning">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="paketWisataFormEdit" action="{{ route('admin.paketWisata.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            {{-- Nama Paket Wisata --}}
            <div class="form-group">
                ...
                <input type="text" name="namaPaket" value="{{ $data->namaPaket }}" class="form-control" id="namaPaket" placeholder="Masukkan Nama Paket Wisata " autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="number" name="harga" value="{{ $data->harga }}" class="form-control" id="harga" placeholder="Masukkan Harga Paket Wisata" autocomplete="off" min="0">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="durasi" value="{{ $data->durasi }}" class="form-control" id="durasi" placeholder="Masukkan Durasi Pelaksanaan" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="lokasi" value="{{ $data->lokasi }}" class="form-control" id="lokasi" placeholder="Masukkan Lokasi" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="waktuTersedia" value="{{ $data->waktuTersedia }}" class="form-control" id="waktuTersedia" placeholder="Masukkan Data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="deskripsi" id="deskripsi" rows="4">{{ $data->deskripsi }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="rute" id="rute" rows="4">{{ $data->rute }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="akomodasi" id="akomodasi" rows="4">{{ $data->akomodasi }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="summernote w-full" name="syaratKetentuan" id="syaratKetentuan" rows="4">{{ $data->syaratKetentuan }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="namaKontak" value="{{ $data->namaKontak }}" class="form-control" id="namaKontak" placeholder="Masukkan Kontak Paket Wisata" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kontak" value="{{ $data->kontak }}" class="form-control" id="kontak" placeholder="Masukkan Kontak Paket Wisata" autocomplete="off">
            ...
            @for($i = 1; $i <= 5; $i++) <div class="form-group">
                ...
                <img src="{{ asset('images/paket-wisata/' . $data->{'gambar' . $i}) }}" id='img-upload{{ $i }}' style="width: 400px;" class="mx-auto">
        </div>
        @endfor
...
<script>
    $(document).ready(function() {
        ...
        $('#paketWisataFormEdit').on('submit', function(event) {
        ...
        $('#paketWisataFormEdit').on('submit', function(event) {
            ...
            if (deskripsi.trim().length === 0) {
                // Field is empty (after trimming whitespaces)
